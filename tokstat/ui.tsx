...
<HStack gap={3}>
      ...
      <Sparkline collection="samples" query={{where:{source:"claude"}}} field="session_pct" limit={30} color={{op:"data", collection:"current", where:{source:"claude"}, latest:true, field:"session_color"}}/>
      )}
    </HStack>
)}
...
<HStack gap={3}>
      ...
      {settings.menubar_style === "trend" && (
      <Sparkline collection="samples" query={{where:{source:"codex"}}} field="session_pct" limit={30} color={{op:"data", collection:"current", where:{source:"codex"}, latest:true, field:"session_color"}}/>
      )}
    </HStack>
)}
      </HStack>
