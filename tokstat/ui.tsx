...
<HStack gap={3}>
      ...
      {settings.menubar_style !== "text" && settings.menubar_style !== "gauge" && (
      <Progress width={24} height={8} value={{op:"data", collection:"current", where:{source:"codex"}, latest:true, field:"session_pct"}} max={100} bands={[{upTo:80, color:{op:"coalesce", args:[{op:"state", path:"/settings/primary_color"}, "primary"]}}, {upTo:95, color:"warning"}, {color:"danger"}]}/>
      )}
      {settings.menubar_style === "text" && (
      <Text content={{op:"data", collection:"current", where:{source:"codex"}, latest:true, field:"session_pct_text"}} className="text-[13px] font-normal tabular-nums"/>
      )}
      {settings.menubar_style === "gauge" && (
      <Meter width={16} height={16} value={{op:"data", collection:"current", where:{source:"codex"}, latest:true, field:"session_pct"}} max={100} bands={[{upTo:80, color:{op:"coalesce", args:[{op:"state", path:"/settings/primary_color"}, "primary"]}}, {upTo:95, color:"warning"}, {color:"danger"}]}/>
      )}
    </HStack>
)}
      </HStack>
...
<HStack justify="between" className="min-w-[54px]">
      <Image height={10} src="data:image/png;base64,"/>
      {settings.menubar_style !== "text" && settings.menubar_style !== "gauge" && (
      <Progress value={{op:"data", collection:"current", where:{source:"codex"}, latest:true, field:"session_pct"}} max={100} bands={[{upTo:80, color:{op:"coalesce", args:[{op:"state", path:"/settings/primary_color"}, "primary"]}}, {upTo:95, color:"warning"}, {color:"danger"}]}/>
      )}
      {settings.menubar_style === "text" && (
      <Text content={{op:"data", collection:"current", where:{source:"codex"}, latest:true, field:"session_pct_text"}} className="text-[13px] font-normal tabular-nums"/>
      )}
